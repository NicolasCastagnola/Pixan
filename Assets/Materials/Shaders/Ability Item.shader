	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color20 = IsGammaSpace() ? float4(0.01455785,1.11183,0,0) : float4(0.001126768,1.262654,0,0);
				...
				float4 color29 = IsGammaSpace() ? float4(0.05176263,0.6784314,0,0) : float4(0.00409638,0.4178852,0,0);
...
/*ASEBEGIN
Version=18900
233;216;1559;471;2001.813;448.9532;2.698199;True;False
...
Node;AmplifyShaderEditor.ColorNode;29;119.3261,190.9891;Inherit;False;Constant;_Color1;Color 1;0;1;[HDR];Create;True;0;0;0;False;0;False;0.05176263,0.6784314,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;20;-381.7827,-434.6259;Inherit;False;Constant;_Color0;Color 0;0;1;[HDR];Create;True;0;0;0;False;0;False;0.01455785,1.11183,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6B19791DAD97A1788E464E262DF94EA4BD91437F