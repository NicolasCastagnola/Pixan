...
Shader "Healing Item"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_anim("anim", Range( 0 , 2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color20 = IsGammaSpace() ? float4(1.11183,0,0.01213594,0) : float4(1.262655,0,0.0009393141,0);
				float2 texCoord11 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord11);
				float simplePerlin2D8 = snoise( panner17*-1.83 );
				simplePerlin2D8 = simplePerlin2D8*0.5 + 0.5;
				
				float4 color29 = IsGammaSpace() ? float4(0.679719,0,0.007015799,0) : float4(0.4196481,0,0.0005430185,0);
				
				float2 texCoord40 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner50 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord40);
				float pixelWidth39 =  1.0f / 32.0;
				float pixelHeight39 = 1.0f / 32.0;
				half2 pixelateduv39 = half2((int)(panner50.x / pixelWidth39) * pixelWidth39, (int)(panner50.y / pixelHeight39) * pixelHeight39);
				float simplePerlin2D36 = snoise( pixelateduv39*300.0 );
				simplePerlin2D36 = simplePerlin2D36*0.5 + 0.5;
				float clampResult49 = clamp( _anim , 0.2 , 1.0 );
				float lerpResult35 = lerp( 1.0 , simplePerlin2D36 , clampResult49);
				float lerpResult41 = lerp( lerpResult35 , 0.0 , ( 1.0 - (1.0 + (_anim - 0.0) * (0.0 - 1.0) / (2.0 - 0.0)) ));
				
				float3 Albedo = ( color20 * simplePerlin2D8 ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( color29 * color29 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18900
233;216;1559;471;2001.813;457.0478;2.698199;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;40;338.7333,433.8981;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;50;338.5193,322.1577;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.5;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;31;255.7333,-148.1019;Inherit;False;Property;_anim;anim;0;0;Create;True;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCPixelate;39;490.7333,320.8981;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;32;False;2;FLOAT;32;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1258.3,-139.9;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;47;886.5267,144.6981;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;2;False;3;FLOAT;1;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;49;656.5193,-146.8423;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.2;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;36;575.7333,91.8981;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;300;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;17;-874.7438,-255.1745;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-0.5;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;46;1104.197,85.29072;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;35;892.7333,-57.1019;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;8;-314.816,-215.5218;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;15,5;False;1;FLOAT;-1.83;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;29;119.3261,190.9891;Inherit;False;Constant;_Color1;Color 1;0;1;[HDR];Create;True;0;0;0;False;0;False;0.679719,0,0.007015799,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;20;-381.7827,-434.6259;Inherit;False;Constant;_Color0;Color 0;0;1;[HDR];Create;True;0;0;0;False;0;False;1.11183,0,0.01213594,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;53;1201.092,-305.5657;Inherit;False;Property;_Keyword0;Keyword 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;15;-1161.906,12.00263;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;45.80614,-230.1832;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;355.0838,-3.351627;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VoronoiNode;10;-87.20963,79.4895;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;3.68;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.LerpOp;41;1317.575,-36.69079;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;12;-1053.5,226;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1770.32,-188.9086;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Healing Item;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=F622958CD8BB3CDE5527BEA01DDB63544FD47805