...
Shader "Trees"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_MudEnemy_lambert1_BaseColor1001("MudEnemy_lambert1_BaseColor.1001", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _MudEnemy_lambert1_BaseColor1001_ST;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MudEnemy_lambert1_BaseColor1001 = IN.ase_texcoord7.xy * _MudEnemy_lambert1_BaseColor1001_ST.xy + _MudEnemy_lambert1_BaseColor1001_ST.zw;
				
				float3 Albedo = tex2D( _MudEnemy_lambert1_BaseColor1001, uv_MudEnemy_lambert1_BaseColor1001 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_MudEnemy_lambert1_BaseColor1001 = IN.ase_texcoord2.xy * _MudEnemy_lambert1_BaseColor1001_ST.xy + _MudEnemy_lambert1_BaseColor1001_ST.zw;
...
/*ASEBEGIN
Version=18900
2506;174;1281;774;802.1365;422.7679;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;32;-505.6436,-158.6139;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCPixelate;31;-249.6436,-117.6139;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;10;False;2;FLOAT;10;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;28;-31.92915,-164.9957;Inherit;True;Property;_MudEnemy_lambert1_BaseColor1001;MudEnemy_lambert1_BaseColor.1001;0;0;Create;True;0;0;0;False;0;False;-1;447accb1872181c4fbb47636fe826658;447accb1872181c4fbb47636fe826658;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;226.3564,87.38611;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;33;755.9031,-374.584;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0.1509434,0.1509434,0.1509434,0;False;2;COLOR;0.5188679,0.5188679,0.5188679,0;False;1;COLOR;0
